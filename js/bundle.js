...
module.exports={
  "name": "downlink",
  "version": "0.5.9b",
  "description": "initial build of Downlink idle game",
  "main": "index.html",
  "dependencies": {
    "break_infinity.js": "^1.0.9",
    "md5": "^2.2.1",
    "save": "^2.4.0"
  },
  "devDependencies": {
  ...
  "scripts": {
    ...
    "bundle": "browserify ./src/Game.js > ./js/bundle.js",
    "compress": "minify ./js/bundle.js > ./js/bundle.packaged.js",
    "package": "npm run bundle && npm run compress",
    "buildTest": "browserify ./test/testIceBreaker.js > ./test/testIceBreaker.build.js"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/CuAnnan/Downlink.git"
  },
  "keywords": [
    "idle",
    "hacking"
  ...
  "license": "ISC",
  "bugs": {
    "url": "https://github.com/CuAnnan/Downlink/issues"
  },
  "homepage": "https://github.com/CuAnnan/Downlink#readme"
}
...
},{"./Helpers":28}],8:[function(require,module,exports){
...
},{"../Computers/ComputerGenerator":13,"../Helpers":28,"./companies":9}],9:[function(require,module,exports){
let companyNames = [
    "Mike Rowe soft",
    "Pear",
    "Outel",
...
},{"../Upgradeable":36,"./Tasks/Task":22,"./cpus":23}],11:[function(require,module,exports){
...
},{"../EventListener":26,"../Helpers":28,"./CPU":10,"./Tasks/Task":22}],12:[function(require,module,exports){
...
},{"../EventListener":26}],13:[function(require,module,exports){
...
},{"../Helpers":28,"../Missions/MissionComputer":34,"./CPU":10,"./Computer":12,"./PlayerComputer":15,"./PublicComputer":16}],14:[function(require,module,exports){
const Computer = require('./Computer');

/**
 * This class' only current reason to exist is to act as a separate parent class for Mission Computer and Player Computer
 * but may develop further purpose later (file structure springs immediately to mind)
 */
class MechanicalComputer extends Computer
{

}

module.exports = MechanicalComputer;
},{"./Computer":12}],15:[function(require,module,exports){
...
},{"../Helpers":28,"../Missions/Challenges/Encryption":30,"../Missions/Challenges/Password":31,"./CPU.js":10,"./CPUPool":11,"./MechanicalComputer":14,"./Tasks/EncryptionCracker":19,"./Tasks/PasswordCracker":20,"./Tasks/ResearchTask":21}],16:[function(require,module,exports){
...
},{"./Computer":12}],17:[function(require,module,exports){
const   helpers = require('../../Helpers'),
        upgradeables = {
            CPU:require('../CPU'),
...
},{"../../Connection":24,"../../EventListener":26,"../../Helpers":28,"../CPU":10,"./researchData":18}],18:[function(require,module,exports){
let researchData = {
    CPU:[
...
},{"../../Alphabet":7,"../../Helpers":28,"./Task":22}],20:[function(require,module,exports){
...
},{"../../Alphabet":7,"./Task":22}],21:[function(require,module,exports){
...
},{"../../Helpers":28,"./Task":22}],22:[function(require,module,exports){
const   EventListener = require('../../EventListener'),
...
},{"../../EventListener":26,"break_infinity.js":1}],23:[function(require,module,exports){
let cpus = [
...
},{"./Computers/Computer":12,"./Computers/PublicComputer":16,"./EventListener":26,"./Helpers":28,"md5":5}],25:[function(require,module,exports){
...
},{"./Companies/Company":8,"./Computers/CPU":10,"./Computers/ComputerGenerator":13,"./Computers/Research/Research":17,"./Connection":24,"./EventListener":26,"./Helpers":28,"./Missions/MissionGenerator":35,"./validWorldMapPoints":37,"break_infinity.js":1}],26:[function(require,module,exports){
class Event
{
...
},{"../package.json":6,"./Computers/CPU":10,"./Computers/Tasks/EncryptionCracker":19,"./Computers/Tasks/PasswordCracker":20,"./Downlink":25,"break_infinity.js":1}],28:[function(require,module,exports){
module.exports = {
...
},{"../../EventListener":26}],30:[function(require,module,exports){
...
},{"../../Helpers":28,"./Challenge":29}],31:[function(require,module,exports){
...
},{"../../Alphabet":7,"../../Helpers":28,"./Challenge":29,"./dictionary":32}],32:[function(require,module,exports){
...
},{"../Companies/Company":8,"../EventListener":26,"../Helpers":28,"../validWorldMapPoints":37,"./Challenges/Encryption":30,"./Challenges/Password":31,"./MissionComputer":34}],34:[function(require,module,exports){
...
},{"../Computers/MechanicalComputer":14}],35:[function(require,module,exports){
...
},{"./Mission":33}],36:[function(require,module,exports){
const EventListener = require('./EventListener');
...
},{"./EventListener":26}],37:[function(require,module,exports){
